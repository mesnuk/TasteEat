    ...
    return (
        <div className="popular-dish-side">
                <TitleHeading span='MENU'
                              ...
                              paragraph='There is a game between the waiters in restaurant to see who serves the food to each table fastest. That led to attempting the Guinness Record.'
                          align='center' />
